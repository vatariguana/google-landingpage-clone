  ...
  return (
    <>
      <div className="col-12 d-hide contenedorAll-items">
        <div className=" contenedor-izquierda-mob">
          <div className="row">
            <div className="col-6 d-hide items-izquierda-mob">
              <a href="https://www.google.com/?pccc=1">
      ...
      <div className="col-12 d-hide contenedorAll-items">
        <div className="contenedor-izquierda-mob">
          <div className="row">
            <div className="col-6 items-izquierda-mob">
      ...
      <div className="col-12 d-hide contenedorAll-items">
        <div className="contenedor-derecha-mob">
          <div className="row">
            <div className="col-4 items-derecha-mob">
